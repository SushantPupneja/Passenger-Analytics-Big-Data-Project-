...
columns = ['date', 'time', 'image_key', 'face_id', 'image_type', 'gender', 'age', 'matched_grp_key', 'similarity', 'location', 'device_type', 'emotion', 'psngr_pnr', 'psngr_flight', 'flight_name', 'destination', 'time_grp', 'age_grp', 'queue_wait_time', 'valid_status']
            ...
            for img in images:
                ...
                if image_type == "Ind":
                    ...
                    if footfall_conversion_process == "True":
                        t1 = threading.Thread(name="Thread_for_log_id-" + str(log_id), target=process_footfall_conversion,
